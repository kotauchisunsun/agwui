...
def inject_class_app(app: Flask, obj: Any):
    ...
    class_template_str = get_default_template("class.html")

    index_class_handler = IndexClassHandler(
        app, function_extractor, get_path_builder, "/", class_template_str)
    handlers = [
        GetFunctionInjector(app, get_path_builder,
                            post_path_builder, get_template_str),
        PostFunctionInjector(app, post_path_builder,
                             preview_image_template_str),
